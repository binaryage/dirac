SDK.CSSMetadata._generatedProperties = [{
    ...
    "keywords": ["inline", "block", "list-item", "inline-block", "table", "inline-table", "table-row-group", "table-header-group", "table-footer-group", "table-row", "table-column-group", "table-column", "table-cell", "table-caption", "-webkit-box", "-webkit-inline-box", "flex", "inline-flex", "grid", "inline-grid", "contents", "flow-root", "none"],
    "name": "display"
}, {
    ...
    "longhands": ["font-style", "font-variant-ligatures", "font-variant-caps", "font-variant-numeric", "font-variant-east-asian", "font-weight", "font-stretch", "font-size", "line-height", "font-family"],
    "name": "font",
    "inherited": true
}, {
    "name": "font-display"
    ...
    "name": "overflow-x",
    "keywords": ["visible", "hidden", "scroll", "auto", "overlay"]
}, {
    "name": "overflow-y",
    "keywords": ["visible", "hidden", "scroll", "auto", "overlay"]
}, {
...
SDK.CSSMetadata._generatedPropertyValues = {
    ...
    "list-style-type": {
        "values": ["disc", "circle", "square", "decimal", "decimal-leading-zero", "arabic-indic", "bengali", "cambodian", "khmer", "devanagari", "gujarati", "gurmukhi", "kannada", "lao", "malayalam", "mongolian", "myanmar", "oriya", "persian", "urdu", "telugu", "tibetan", "thai", "lower-roman", "upper-roman", "lower-greek", "lower-alpha", "lower-latin", "upper-alpha", "upper-latin", "cjk-earthly-branch", "cjk-heavenly-stem", "ethiopic-halehame", "ethiopic-halehame-am", "ethiopic-halehame-ti-er", "ethiopic-halehame-ti-et", "hangul", "hangul-consonant", "korean-hangul-formal", "korean-hanja-formal", "korean-hanja-informal", "hebrew", "armenian", "lower-armenian", "upper-armenian", "georgian", "cjk-ideographic", "simp-chinese-formal", "simp-chinese-informal", "trad-chinese-formal", "trad-chinese-informal", "hiragana", "katakana", "hiragana-iroha", "katakana-iroha", "none"]
    },
    "shape-rendering": {
    ...
    "render-subtree": {
        "values": ["none", "invisible", "skip-activation", "skip-viewport-activation"]
    },
    "border-left-style": {
        "values": ["none", "hidden", "inset", "groove", "outset", "ridge", "dotted", "dashed", "solid", "double"]
    },
    ...
    "text-justify": {
        "values": ["auto", "none", "inter-word", "distribute"]
    },
    "image-rendering": {
    ...
    "alignment-baseline": {
        "values": ["baseline", "alphabetic", "ideographic", "middle", "central", "mathematical"]
    },
    ...
    "display": {
        "values": ["inline", "block", "list-item", "inline-block", "table", "inline-table", "table-row-group", "table-header-group", "table-footer-group", "table-row", "table-column-group", "table-column", "table-cell", "table-caption", "-webkit-box", "-webkit-inline-box", "flex", "inline-flex", "grid", "inline-grid", "contents", "flow-root", "none"]
    },
    "border-left-width": {
        "values": ["thin", "medium", "thick"]
    },
