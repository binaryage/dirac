function setRunnerFavicon(state) {
  ...
  if (state == "running") {
    favicon.change(["data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAMAAABEpIrGAAABSlBMVEUAAAAARN0ARN0ARN0ARN0ARN0ARN",
  ...
  if (state == "finished") {
    favicon.change(["data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAMAAABEpIrGAAABQVBMVEUAAAAAqgAAqgAAqgAAqgAAqgAAqg",
  ...
  if (state == "timeout") {
    favicon.change(["data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAMAAABEpIrGAAAAyVBMVEUAAACZmQCZmQCZmQCZmQCZmQCZmQ",
  ...
  if (state == "exception") {
    favicon.change(["data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACAAAAAgCAMAAABEpIrGAAAAyVBMVEUAAACqAACqAACqAACqAACqAACqAA",
