(ns ^:figwheel-hooks dirac-gpig.core
...
(println "This text is printed from src/dirac_gpig/core.cljs. Go ahead and edit it and see reloading in action.")
...
(defn hello-world [state]
  (sab/html [:div
             [:h1 (:text @state)]
             [:h3 "Edit this in src/dirac_gpig/core.cljs and watch it change!"]]))
